...
const FeatureCard: FC<FeatureCardProps> = ({ service, onClick, theme }) => (
  <motion.div
    ...
    onClick={onClick}
    className={`rounded overflow-hidden w-full h-[240px] md:h-[330px] hover:shadow-lg transition-shadow duration-300 cursor-pointer text-center transform mb-4 ${
      theme === 'dark'
  ...
  >
    <img
      src={service.image}
      alt={service.name}
      className="w-full h-[100px] md:h-[170px] object-cover"
    />
    <div className="text-start mt-3 md:p-4 relative">
